...
def main_start():
    ...
    if image_width>=1000:
        img = resize_image_width(image_path, 300)
    elif 700<=image_width<1000:
        img = resize_image_scale(image_path, 50)
    else:
        img = resize_image_scale(image_path, 100)
...
def establish_connection():
    global ser
    ser = serial.Serial('COM3', 115200) # Replace COM3 with the serial port connected to the GRBL board
